...
let solutionFile  = "Noggle.TikaOnDotNet.sln"
...
Target "RunTests" (fun _ ->
    ...
    |> NUnit3 (fun p ->
        { p with
            OutputDir = artifactDir + "/TestResult.xml" })
)
...
Target "CompileTikaLib" (fun _ ->
    ...
    |> Seq.map (fun name -> IKVMcTask(name, "Noggle.TikaOnDotNet", Version=release.AssemblyVersion))
